...
Código del juego sin licencia explícita en la raíz del repo; el addon `addons/godot_ai` tiene su propia licencia en `addons/godot_ai/LICENSE`.

## Créditos

Prototipo **Kage** — duelo de espías en Godot 4.
